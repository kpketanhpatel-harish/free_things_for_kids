  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="inline-flex rounded-lg bg-amber-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
      >
        Feedback
      </button>
